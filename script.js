...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (checkoutButton) {
        checkoutButton.addEventListener('click', function(e) {
            ...
            if (cart.length === 0) {
                if (typeof N2XT !== 'undefined' && N2XT.showNotification) {
                    N2XT.showNotification('Your cart is empty!', 'warning');
                } else {
            ...
            // Sauvegarder le panier pour la page de paiement
            localStorage.setItem('n2xt-checkout-cart', JSON.stringify(cart));
